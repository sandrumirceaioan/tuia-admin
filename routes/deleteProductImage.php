...
$small_img = '../images/products/small/';
$large_img = '../images/products/';

$upd_product_image = mysqli_query($conexiune, "UPDATE main_table SET the_image = '".$string."' WHERE the_id = ".$data->id."");
