        ...
        $layout_single = file_get_contents('html/blog-single.html');
            ...
            if($url == 'blog') {
                ...
                while ($blog = mysql_fetch_assoc($query)) {
                    ...
                    $layout_list = str_replace('{{_POST_IMAGE}}',$img_json[0]['image'],$layout_list);
                    ...
                    $recent_posts .= '<li><a href="/blog/'.$blog['the_url'].'">'.$blog['the_title'].'</a></li>';
            ...
            //if is single post page
                ...
                $layout_single = str_replace('{{_POST_IMAGE}}',$img_json[0]['image'],$layout_single);
				...
				$layout_single = str_replace('{{_POST_KEYWORDS}}',$blog['the_metakeywords'],$layout_single);
